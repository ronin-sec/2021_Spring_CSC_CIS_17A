...
void displayCaps(Ply move, Piece whitArr[], Piece blckArr[], vector<string> &wCaps, vector<string> &bCaps){
    ...
    for(int i =0 ; i < 16 ; i++){                                                        
        if(whitArr[i].captured == false){      //Skip piece if not captured                             
            continue; 
        }else if(whitArr[i].captured != false){ //If captured write to vector                     
            wCaps.push_back(whitArr[i].letters);
        }
    }
    ...
    for(int i =0 ; i < 16 ; i++){                                                        
        if(blckArr[i].captured == false){     //Skip piece if not captured               
            continue; 
        }else if(blckArr[i].captured != false){ //If captured write to vector            
            bCaps.push_back(blckArr[i].letters);
        }
    }
